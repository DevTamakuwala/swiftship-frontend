...
export default function Header() {
  ...
  const navigationItems = [
    ...
    { path: '/routes', label: 'Our Network' },
    {
      path: '#',
      label: 'Major Cities',
      dropdown: [
        { path: '/cities/delhi', label: 'Delhi NCR' },
        { path: '/cities/mumbai', label: 'Mumbai' },
        { path: '/cities/bangalore', label: 'Bangalore' },
        { path: '/cities/chennai', label: 'Chennai' },
        { path: '/cities/kolkata', label: 'Kolkata' },
        { path: '/cities/surat', label: 'Surat' }
      ]
    },
